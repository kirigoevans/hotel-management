...
<div class="row">
  ...
  <div class="row">
   ...
   <label for="inputAddress2">Description (Note: Requests <strong>WITHOUT</strong> a description have the <strong style="color: red;">Lowest Priority</strong>)</label>
    <textarea type="text"  name="emergency_description"class="form-control" id="inputAddress2" placeholder="Optional: A Short Description of what kind of food"></textarea>
